...
bool CApp::OnInit() {
	...
	moveDirX = 0;
	moveDirY = 0;
	curPosX = 10;//should range from 0-19. Multiply by 32 to get left pixel position of the box thing.
	curPosY = 10;//should range from 0-14. Multiply by 32 to get top pixel position of the box thing.
